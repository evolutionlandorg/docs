...
**成功率：**按配方成功合成/拆解实行的可能性，目前仅有铸造成功率不是100%。可以通过治理系统调整。

在未来铁匠职业也会提高成功率。

**铸造：**用基础的NFT和FT资产创造一个新的NFT。

**升级：**用FT资产和NFT资产提升NFT的属性。
...
1. 如果钻头在保护期内, 不可以被抢占.
2. 地主可以抢占地块上其他不在保护期内的任意等级钻头
3.

```
A 道具：新的，打算进行部署的道具 (非地主)
...
1. 我是地主，我放一个 1-3 钻头放在自己的地块上，不在保护期，他人可以用 1-1 级钻头可以抢占吗？（不可以）
2. 我是地主，我放一个 1-3 钻头放在自己的地块上，不在保护期，他人可以用 1-3 级钻头可以抢占吗？（不可以）
3. 我是地主，我放一个 1-3 钻头放在自己的地块上，不在保护期，他人可以用 2-1 级钻头可以抢占吗？（可以）
4. 我是地主，我放一个 1-2 钻头放在自己的地块上，不在保护期，他人可以用 1-3 级钻头可以抢占吗？（可以）
5. 我是地主，他人放一个 2-3 钻头放在自己的地块上，不在保护期，我可以用 1-1 级钻头可以抢占吗？（可以）
6. 我放一个 1-3 钻头放在C的地块上，不在保护期，A可以用 1-3 钻头可以抢占吗？（不可以）
7. 我放一个 1-3 钻头放在C的地块上，不在保护期，A可以用 2-1 钻头可以抢占吗？（可以）
```
...
1. 钻头保护期内卸下重新装备钻头, 保护期继承未完成的保护期.
2. 钻头保护期结束后卸下重新装备钻头, 保护期重新计算.
